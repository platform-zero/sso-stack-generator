...
grep -Fq './configs/service-contracts.json:/contracts/service-contracts.json:ro' "$ROOT_DIR/stack.compose/portal.yml"
...
if ! rg -n 'ghcr\.io/gethomepage/homepage|portal:8080' "$ROOT_DIR/stack.compose/portal.yml" "$ROOT_DIR/stack.config/caddy/Caddyfile" >/dev/null; then
